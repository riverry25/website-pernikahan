const w = (n, e, o, t, l, d) => {
  ...
  b = (n, e, o) => {
    const t = n.querySelector(".simply-amount"),
      l = n.querySelector(".simply-word");
    t && (t.textContent = String(e)), l && (l.textContent = o);
  },
  E = (n, e) => {
    const o = "simply-amount",
      t = "simply-word",
      l = w("simply-section simply-days-section", o, t, 0, "day", e),
      d = w("simply-section simply-hours-section", o, t, 0, "hour", e),
      u = w("simply-section simply-minutes-section", o, t, 0, "minute", e),
      c = w("simply-section simply-seconds-section", o, t, 0, "second", e);
    return (
      n.appendChild(l),
      n.appendChild(d),
      n.appendChild(u),
...
function M(n, e, o) {
  const t = n
    .filter((l, d) => S(l, n.slice(0, d), e))
    .map((l) => I(l, e))
    .join(e.inlineSeparator);
  o.innerHTML = t;
}
function $(n, e, o) {
  n.forEach((t, l) => {
    t.word === "seconds" || S(t, n.slice(0, l), e)
      ? (b(o[t.word], e.zeroPad ? String(t.value).padStart(2, "0") : t.value, e.words[t.word].lambda(e.words[t.word].root, t.value)), (o[t.word].style.display = ""))
      : (o[t.word].style.display = "none");
  });
}
const y = (n, e) => {
    let o = {
    ...
    const d = e.inline
      ...
      U = (s) => {
        var i;
        Object.assign(e, s),
          (s.year !== void 0 || s.month !== void 0 || s.day !== void 0 || s.hours !== void 0 || s.minutes !== void 0 || s.seconds !== void 0) && (o.targetDate = t(e)),
          (i = e.onUpdate) == null || i.call(e, s),
          o.isPaused || (o.interval && clearInterval(o.interval), c());
      },
      p = () => ({ ...o });
    c();
    ...
    return (
      n.parentNode && h.observe(n.parentNode, { childList: !0 }),
      {
        stopCountdown: a,
        resumeCountdown: r,
        updateCountdown: U,
  ...
  D = (n) => {
    const e = n;
    return (
      (e.stopCountdown = () => n.forEach((o) => o.stopCountdown())),
      (e.resumeCountdown = () => n.forEach((o) => o.resumeCountdown())),
      (e.updateCountdown = (o) => n.forEach((t) => t.updateCountdown(o))),
      (e.getState = () => n.map((o) => o.getState())),
      e
    );
  },
  x = (n, e = m) => {
